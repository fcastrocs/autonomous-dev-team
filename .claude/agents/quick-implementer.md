...
description: "Specialist agent: quick-implementer"
...
- NEVER synchronize or manually patch generated build assets. That is handled deterministically via `python3 sync.py`.
...
- Never manually copy or patch generated files: `.git/**`, `__pycache__/**`, `.codex/**`, `.pytest_cache/**`
